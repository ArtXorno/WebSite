...
namespace ArtXornoSite
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //настраивапем политику авторизации для Admin area
            ...
            services.AddControllersWithViews(x =>
            {
                ...
                //выставляем совместимость с aps.net core 3.0(чтобы при обновлении не потерялся функционал ставим 3.0)
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //регистрируем нужные нам маршрнуты(endpoints)
